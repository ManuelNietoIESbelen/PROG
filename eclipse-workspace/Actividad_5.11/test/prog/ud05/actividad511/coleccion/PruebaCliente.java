...
class PruebaCliente {
  ...
  void testClienteNombreNull() {
    ...
    assertThrows(NullPointerException.class, () -> new Cliente(nombre, apellidos, dni, edad), "Se ha creado un cliente con nombre null");
  }
  ...
  void testClienteApellidosNull() {
    ...
    assertThrows(NullPointerException.class, () -> new Cliente(nombre, apellidos, dni, edad), "Se ha creado un cliente con apellidos null");
  }
  ...
  void testClienteDniNull() {
    ...
    assertThrows(NullPointerException.class, () -> new Cliente(nombre, apellidos, dni, edad), "Se ha creado un cliente con dni null");
  }
